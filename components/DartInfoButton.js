...
// Lille spørgsmålstegns-knap ved siden af "RESERVE A SPOT"
// Viser en forklarende popup om hvordan tilmeldingen til dart fungerer
export default function DartInfoButton() {
        ...
        >
          ...
          >
            <p className="text-lg leading-relaxed">
              Click <span className="italic font-semibold">Reserve a spot</span>{" "}
              to see all 30-minute time slots and secure your spot by giving
