    ...
    <div className="min-h-screen pt-20 pb-10 px-5 flex items-center justify-center">
      <main className="text-center max-w-[600px]">
        <Image
          ...
          className="mb-8 w-dvh h-auto from-transparent to-black/95"
        ></Image>
        ...
        <p className="text-2xl font-body text-center text-[#FFF5D6] mb-8">
          Such tricky and funny questions you will have to answer together with
          your friends or family in our PUB QUIZ in the Golden Lion.
        </p>
        <Image
          width={600}
          height={600}
        ...
        ></Image>
        <p className="text-2xl font-body text-center text-[#FFF5D6] mb-8">
          Every <strong>Friday</strong> at 20:00 - to start your weekend in the
          perfect way!
        </p>
        <p className="text-2xl font-body text-center text-[#FFF5D6] mb-8">
